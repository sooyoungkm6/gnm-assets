...
(function () {
  var CONFIG = {
    id: 'gnm-popup-2026-08-liberation',
    img: 'https://cdn.jsdelivr.net/gh/sooyoungkm6/gnm-assets@main/2026-08-liberation-day/notice-600.png',
    alt: '굿나잇몰 광복절 연휴 휴무 안내 8/14(금)-8/17(월)',
    start: '2026-08-11T00:00:00+09:00',
    end: '2026-08-18T23:59:59+09:00',
    link: '',  // 클릭 시 이동할 공지 URL (비우면 이동 없음)
    banner: {
      html: '광복절 연휴 휴무 <b style="color:#FCB825">8/14(금)–8/17(월)</b> · 8/13(목) 15시 결제분까지 당일 출고 · <b style="color:#FCB825">8/18(화) 정상재개</b>',
      start: '2026-08-11T00:00:00+09:00',
      end: '2026-08-18T23:59:59+09:00'
    }
  };
