...
(function () {
  var CONFIG = {
    id: 'gnm-popup-2026-09-chuseok',
    img: 'https://cdn.jsdelivr.net/gh/sooyoungkm6/gnm-assets@main/2026-09-chuseok/notice-600.png',
    alt: '굿나잇몰 추석 연휴 휴무 안내 9/23(수)-9/25(금)',
    start: '2026-09-17T00:00:00+09:00',
    end: '2026-09-28T23:59:59+09:00',  // 정상재개일 23:59 까지 (사장 확정 2026-07-27)
    link: '',  // 클릭 시 이동할 공지 URL (비우면 이동 없음)
    banner: {
      html: '추석 연휴 휴무 <b style="color:#FCB825">9/23(수)–9/25(금)</b> · 9/22(화) 15시 결제분까지 당일 출고 · <b style="color:#FCB825">9/28(월) 정상재개</b>',
      start: '2026-09-17T00:00:00+09:00',  // 배너는 네이버 전체공지와 동일하게 즉시 시작
      end: '2026-09-28T23:59:59+09:00'
    }
  };
